const checkIcon = (
    <svg width="8" height="6" viewBox="0 0 8 6" className="fill-current text-green-600">
  ...
  const crossIcon = (
    <svg width="7" height="7" viewBox="0 0 8 8" className="fill-current text-red-600">
  ...
  const OfferList = ({
    ...
    return (
      <div className="mb-3 flex items-center">
        ...
        <p className="m-0 text-base font-medium text-gray-500">{text}</p>
      </div>
    );
  };
